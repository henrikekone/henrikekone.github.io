...
const config = {
  github: {
    username: 'henrikekone', // Your GitHub org/user name. (Required)
    sortBy: 'stars', // stars | updated
    limit: 10, // How many projects to display.
    exclude: {
      forks: false, // Forked projects will not be displayed if set to true.
      projects: ['henrikekone.github.io'], // These projects will not be displayed. example: ['my-project1', 'my-project2']
    },
  },
  social: {
    linkedin: 'henrike-kone',
    twitter: '',
    mastodon: '',
    facebook: '',
    instagram: '',
